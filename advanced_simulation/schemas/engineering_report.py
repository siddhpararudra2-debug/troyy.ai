...
class ReportContext:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        # We don't suppress exceptions, they will propagate normally
        return False
    ...
    def finalize(self, final_results: dict, interpretation: str):
        ...
        self.report.validation_results = {"day7_status": "VALIDATED", "checks": ["units_homogeneous", "bounds_respected"]}
